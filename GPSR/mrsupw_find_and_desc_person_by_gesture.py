...
def call_back(target_index):
    ...
    while True:
        ...
        if len(final_results) == 0:
            continue
        print(colored('final_results:{}'.format(final_results)))
        result = find_person_by_gesture(final_results, target_index)
        if result:
            ...
            transformed_cor = [coordinate[2], -coordinate[0], -coordinate[1]]
            print(colored("transformed coordinate:{}".format(transformed_cor)))
